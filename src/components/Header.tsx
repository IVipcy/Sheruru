      ...
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            {showNotif && (
              <div className="absolute right-0 mt-2 w-72 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-3 shadow-xl">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg px-3 py-1.5 transition-colors hover:bg-[var(--color-surface-light)]"
          >
          ...
          <button
            ...
            title="ログアウト"
            className="relative z-[100] rounded-lg p-2 text-[var(--color-text-muted)] transition-colors hover:bg-[var(--color-surface-light)] hover:text-red-400"
          >
            <LogOut size={16} />
          </button>
        </div>
