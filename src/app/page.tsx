    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12">
        <div className="mb-10 text-center">
          <h2 className="text-2xl font-bold">モードを選択してください</h2>
          <p className="mt-2 text-sm text-[var(--color-text-muted)]">目的に応じたモードでAIアバターがサポートします</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {MODES.map((mode) => (
            ...
            >
              ...
              <div className={`mt-4 h-1 w-12 rounded-full ${mode.color} opacity-60 transition-all group-hover:w-20 group-hover:opacity-100`} />
            </button>
          ))}
        </div>
      </main>
